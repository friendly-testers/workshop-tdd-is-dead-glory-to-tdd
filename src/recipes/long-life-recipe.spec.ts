...
describe(LongLifeRecipe.name, () => {
    ...
    describe('successCondition', () => {
        it.each<{ ingredients: Ingredient[] }>([
            ...
            'should return true if the number of ingredients is equal to necessary ingredients and there are at least 4 different ingredients',
            ({ ingredients }) => {
        ...
        it.each([
            ...
            'should return false if the number of ingredients is not equal to necessary ingredients',
            ({ ingredients }) => {
                const result = recipe.successCondition(ingredients);
